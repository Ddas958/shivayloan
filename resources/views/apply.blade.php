            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    <div class="get-in-touch">
                        ...
                        <h3>Professionals Deatils</h3>
                    </div>
                    
                    <form action="{{route('apply')}}" method="POST" enctype="multipart/formdata">
                        @csrf
                        <div class="row list-input">
                            ...
                            <div class="col-md-6">
                                <div class="single-get-touch">
                                    <select type="select" name="occupation" placeholder="Occupation" required>
                                        <option value="" readonly>Occupation</option>
                            ...
                            <div class="col-md-6">
                                <div class="single-get-touch">
                                <input type="text" name="pincode" placeholder="Pincode" id="">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="single-get-touch">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="single-contact-info">
                        ...
                        <div class="content">
                            <p><a href="tel:9650232300">+91 9650232300</a> <br>Call @ 8.30am to 5.00pm </p>
                        </div>
                    </div>
                </div>
            </div>
