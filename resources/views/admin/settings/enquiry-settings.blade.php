@section('title','Loan Enquiry Settings')
@extends('admin.main')
@section('content')
...
<div class="space-y-8">
    ...
    @include('admin.message')
        <form id="ContactSettingsForm" action="{{route('admin.SaveSettings','enquiry-settings')}}" method="POST" enctype="multipart/form-data">
        @csrf
            <div class="card">
                <div class="card-body flex flex-col p-6">
                    <!-- <header class="flex mb-5 items-center border-b border-slate-100 dark:border-slate-700 pb-5 -mx-6 px-6">
                        <div class="flex-1">
                            <div class="card-title text-slate-900 dark:text-white">Loan Enquiries</div>
                        </div>
                    </header> -->
                        ...
                        <div>
                            <ul class="nav nav-pills flex items-center flex-wrap list-none pl-0 mb-6 space-x-4 " id="pills-tabHorizontal" role="tablist">
                                <li class="nav-item text-center" role="presentation">
                                    <a href="#pills-contentHorizontal" class="nav-link block font-medium font-Inter text-sm leading-tight capitalize rounded-md px-6 py-3 focus:outline-none focus:ring-0 active dark:bg-slate-900 dark:text-slate-300" id="pills-home-tabHorizontal" data-bs-toggle="pill" data-bs-target="#pills-contentHorizontal" role="tab" aria-controls="pills-contentHorizontal" aria-selected="true">Loan Equiries</a>
                                </li>
                            </ul>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="table-td">
                                                                        <div class="flex space-x-3 rtl:space-x-reverse">
                                                                            <a class="action-btn" href="{{ route('admin.viewLoanEnquiry',$item->id) }}">
                                                                                <iconify-icon icon="heroicons:eye"></iconify-icon>
                                                                            </a>
                                                                            <a class="action-btn" href="{{ route('admin.deleteLoanEnquiry',$item->id) }}">
