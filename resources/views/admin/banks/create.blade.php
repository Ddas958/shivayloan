...
<div class="card">
    ...
    <div class="card-body">
        <h6>Add Banking Partner</h6>
        <form action="{{ route('admin.addBank') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group py-4 mb-3">
                <button type="submit" class="btn btn-primary">Save Banking Partner</button>
            </div>
